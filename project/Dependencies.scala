...
object Dependencies {
  ...
  object Compile {
    ...
    val `akka-stream-kafka` = "com.typesafe.akka"             %% "akka-stream-kafka"      % "0.11-RC2"

  }

  object Test {
    val specs2              = "org.specs2"                    %%  "specs2-core"           % "3.8.4"
    val `akka-slf4j`        = "com.typesafe.akka"             %%  "akka-slf4j"            % "2.4.9"
  }
